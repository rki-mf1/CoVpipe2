...
```{r nextclade}
dt.nextclade_results$seqName <-  unlist(lapply(strsplit(dt.nextclade_results$seqName, '_iupac_consensus_unknown_version'), function(e){
    return(e[1])
  }))
datatable(dt.nextclade_results[,c("seqName", "aaSubstitutions", "aaDeletions", "aaInsertions", "frameShifts")], 
      colnames = c("sample", "aaSubstitutions", "aaDeletions", "aaInsertions call", "frameShifts"),
      rownames = FALSE,
