...
```{r nextclade}
dt.nextclade_results$frameShifts <- ifelse(! is.na(dt.nextclade_results$frameShifts),
                                    cell_spec(dt.nextclade_results$frameShifts, background = "red", align = "right"),
                                    dt.nextclade_results$frameShifts)
