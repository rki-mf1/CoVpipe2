...
if(params$kraken_table != 'none'){
  dt.overview <- merge(x=dt.kraken_table, y=dt.president_results, by='sample')
} else {
  dt.overview <- dt.president_results
}
...
datatable(dt.overview[,c("sample", "kraken2_ratio_sarscov2", "president_QC_pass", "president_identity", "pangolin_lineage","scorpio_constellation", "nextclade_frameshifts","nextclade_privateMutations_status")], 
      colnames = c("Sample", "Severe acute respiratory syndrome coronavirus 2 (ratio)", "Genome QC", "%N", "Linage", "Scorpio call", "Frameshifts", "Private mutations QC"),
      rownames = FALSE,
