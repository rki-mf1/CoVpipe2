...
dt.president_results <- dt.president_results[,c("query_name", "qc_all_valid", "ACGT Nucleotide identity", "N_bases", "Mismatches")]
...
datatable(dt.president_results, 
      colnames = c("sample", "QC status", "ACGT Nucleotide identity", "#N", "Mismatches"),
      rownames = FALSE,
