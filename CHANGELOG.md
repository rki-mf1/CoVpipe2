...
- reporting of number of Ns in Spike
- reporting of number of mixed variants (form VCF file)
- more variant filtering options (default unchanged):
  - `--cns_gt_adjust_ao` (previously `--cns_gt_adjust`), and
  - `--cns_gt_adjust_ro`
