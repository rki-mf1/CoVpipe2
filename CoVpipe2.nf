...
workflow {
    ...
    annotate_variant(variant_calling.out.vcf, generate_consensus.out.consensus_ambiguous, 'sars-cov-2', params.nextclade_dataset_version, 'NC_045512.2')
