process rki_report {
    label 'python'
    publishDir "${params.output}/${params.rki_dir}/valid", mode: params.publish_dir_mode, pattern: "rki_valid_report.csv"
    publishDir "${params.output}/${params.rki_dir}", mode: params.publish_dir_mode, pattern: "${readme}"
